...
import { useEditor, useNode, UserComponentConfig } from "@craftjs/core";
...
type ComponentType<T> = React.ForwardRefExoticComponent<React.PropsWithoutRef<PropsWithChildren<T>> & React.RefAttributes<HTMLElement>> & {
  craft: UserComponentConfig<T>;
};

export const withNode = <T extends {}>(Component: React.ComponentType<T>, { draggable = true, droppable = true } = {}): ComponentType<T> => {
  ...
  return WithNode as ComponentType<T>;
};
